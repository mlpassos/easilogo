...
Logo.prototype.setup = function () {
    ...
    this.addCommand('forward',1,['fw','fd'], function (a) { 
        if (parseFloat(a[0]) != a[0]) return new Token('error','Forward pode ser somente um número, não '+a[0])
...
Logo.prototype.run = function (code) {
    ...
    // aqui teoricamente eh o fim, mas nao funciona
    //alert(this.turtle.active);
